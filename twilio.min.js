        ...
        function (require, module, exports) {
          ...
          var PreflightTest = (function (_super) {
            ...
            PreflightTest.prototype.stop = function () {
              ...
              if (this.contactController.device) {
                this.contactController.device.once(
                  device_1.default.EventName.Unregistered,
                  function () {
                    return _this._onFailed(error);
                  }
                );
                this.contactController.device.destroy();
              } else {
            ...
            PreflightTest.prototype._initDevice = function (token, options) {
              var _this = this;
              try {
                this.contactController.device = new (options.deviceFactory || device_1.default)(
                  token,
                  {
                ...
                this.contactController.device.register();
              } catch (error) {
                setTimeout(function () {
                ...
                return __generator(this, function (_b) {
                  switch (_b.label) {
                    case 0:
                      ...
                      return [
                        4,
                        this.contactController.device.connect({
                    ...
                    case 1:
                      ...
                      this._edge = this.contactController.device.edge || undefined;
                      if (this._options.fakeMicInput) {
                        this._echoTimer = setTimeout(function () {
                          return _this.contactController.device.disconnectAll();
                        }, ECHO_TEST_DURATION);
                        audio = this.contactController.device.audio;
                        if (audio) {
                      ...
                      this._call.once("disconnect", function () {
                        _this.contactController.device.once(
                          device_1.default.EventName.Unregistered,
                          function () {
                            return _this._onUnregistered();
                          }
                        );
                        _this.contactController.device.destroy();
                      });
            ...
            PreflightTest.prototype._releaseHandlers = function () {
              [this.contactController.device, this._call].forEach(function (emitter) {
                if (emitter) {
